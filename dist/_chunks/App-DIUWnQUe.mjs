...
import { getFetchClient, useNotification, Page } from "@strapi/strapi/admin";
import { useParams, useSearchParams, useNavigate, Link as Link$1, Routes, Route } from "react-router-dom";
...
import { Trash, Plus, Pencil, Cog, Duplicate, Eye } from "@strapi/icons";
import { useState, useImperativeHandle, forwardRef, useRef, useEffect, useMemo } from "react";
import { P as PLUGIN_ID } from "./index-CDLNC01I.mjs";
const { get: get$9, post: post$3, put: put$2, del: del$5 } = getFetchClient();
const createNamespace = async ({
  projectId,
  name,
  description
}) => {
  return post$3(`/${PLUGIN_ID}/api/projects/${projectId}/namespaces`, { name, description }).then(
    (res) => res.data
  );
};
const updateNamespace = async ({
  ...
  return put$2(`/${PLUGIN_ID}/api/projects/${projectId}/namespaces/${id}`, {
    name,
    description
  }).then((res) => res.data);
};
const deleteNamespace$1 = async (id) => {
  return del$5(`/${PLUGIN_ID}/api/projects/${id}/namespaces/${id}`).then((res) => res.data);
};
...
const { get: get$8, del: del$4 } = getFetchClient();
...
const deleteNamespace = async ({
  ...
  try {
    const response = await del$4(`/${PLUGIN_ID}/api/projects/${projectId}/namespaces/${namespaceId}`);
...
const { get: get$7, post: post$2 } = getFetchClient();
const getApiKey = async () => {
  return get$7(`/${PLUGIN_ID}/api/settings/api-key`).then((res) => res.data);
};
const regenerateApiKey = async () => {
  const res = await post$2(`/${PLUGIN_ID}/api/settings/api-key/regenerate`);
  return res.data;
};
const useHook$5 = () => {
...
const ProjectCard = ({
  ...
  /* @__PURE__ */ jsxs(Flex, { display: "flex", gap: "15rem", justifyContent: "flex-start", padding: "1rem", width: "100%", children: [
    /* @__PURE__ */ jsx(Flex, { display: "flex", children: /* @__PURE__ */ jsx(
      Button,
      {
        color: "white",
        gap: "0",
        onClick: onViewAllTranslations(project),
        startIcon: /* @__PURE__ */ jsx(Eye, { color: "white" }),
        title: "View all translations"
      }
    ) }),
    /* @__PURE__ */ jsxs(Flex, { display: "flex", gap: "0.5rem", justifyContent: "flex-end", children: [
      /* @__PURE__ */ jsx(
        Button,
        {
          color: "white",
...
const { post: post$1, put: put$1, del: del$3 } = getFetchClient();
const createProject = async ({ name, description }) => {
  return post$1(`/${PLUGIN_ID}/api/projects`, { name, description }).then((res) => res.data);
};
const updateProject = async ({ id, name, description }) => {
  return put$1(`/${PLUGIN_ID}/api/projects/${id}`, { name, description }).then((res) => res.data);
};
const deleteProject$1 = async (id) => {
  return del$3(`/${PLUGIN_ID}/api/projects/${id}`).then((res) => res.data);
};
...
const { get: get$6, del: del$2 } = getFetchClient();
const getProjects = async () => {
  const { data } = await get$6(`/${PLUGIN_ID}/api/projects`);
  return data;
};
const deleteProject = async (id) => {
  const { data } = await del$2(`/${PLUGIN_ID}/api/projects/${id}`);
  return data;
};
const useHook$3 = () => {
  const { toggleNotification } = useNotification();
...
const { get: get$5 } = getFetchClient();
const getNamespaces = async (projectId) => {
  return get$5(`/${PLUGIN_ID}/api/projects/${projectId}/namespaces/all`).then(
    (res) => res.data
  );
};
...
const { get: get$4 } = getFetchClient();
...
const { get: get$3, post, put, del: del$1 } = getFetchClient();
...
const Translations = () => {
    ...
    if (!isPending && !!translations?.items && !translations?.items.length) {
      return /* @__PURE__ */ jsx(Box, { background: "neutral100", children: /* @__PURE__ */ jsx(
        EmptyStateLayout,
        {
          ...
          action: /* @__PURE__ */ jsx(Button, { onClick: handleTranslationCreate, startIcon: /* @__PURE__ */ jsx(Plus, {}), variant: "secondary", children: "Create translation" })
        }
      ) });
    }
    return /* @__PURE__ */ jsx(Fragment, {});
  ...
  const renderContent = () => {
    ...
    return /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsxs(Box, { paddingTop: "1rem", paddingBottom: "1rem", children: [
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsxs(Flex, { marginBottom: "1rem", gap: "1rem", children: [
...
const { get: get$2 } = getFetchClient();
const getNamespace = async (id) => {
  return get$2(`/${PLUGIN_ID}/api/projects/${id}/namespaces/${id}`).then((res) => res.data);
};
...
const { get: get$1, del } = getFetchClient();
...
const ProjectTranslations = () => {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsx(Flex, { marginBottom: "1rem", gap: "1rem", children: /* @__PURE__ */ jsx(
      Switch,
      {
        checked: showMissingTranslationsOnly,
        name: "showMissingTranslationsOnly",
...
const ProjectTranslationsPage = () => {
  ...
  return /* @__PURE__ */ jsxs(Main, { padding: "2rem", children: [
    /* @__PURE__ */ jsxs(Box, { paddingBottom: "1rem", children: [
      ...
      /* @__PURE__ */ jsxs(Breadcrumbs, { label: "Folder navigatation", children: [
        /* @__PURE__ */ jsx(CrumbLink, { href: `/admin/plugins/${PLUGIN_ID}`, children: "Projects" }),
        /* @__PURE__ */ jsxs(Crumb, { isCurrent: true, children: [
          "All translations ",
          project ? ` - ${project.name}` : ""
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsx(Box, { padding: "1rem", children: /* @__PURE__ */ jsx(ProjectTranslations, {}) })
  ] });
};
const App = () => {
  return /* @__PURE__ */ jsx(DesignSystemProvider, { locale: "en-GB", theme: darkTheme, children: /* @__PURE__ */ jsxs(Routes, { children: [
    ...
    /* @__PURE__ */ jsx(
      Route,
      {
        ...
        element: /* @__PURE__ */ jsx(ProjectTranslationsPage, {})
      }
    ),
    /* @__PURE__ */ jsx(
      Route,
