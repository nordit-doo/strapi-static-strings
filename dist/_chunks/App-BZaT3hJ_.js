...
const getNamespaces$2 = async ({ page, projectId }) => {
  return axios(
    `/${index.PLUGIN_ID}/api/projects/${projectId}/namespaces/missing-translations?page=${page}`
  ).then((res) => res.data);
};
...
const getTranslation = async ({
  ...
  return axios.get(
    `/${index.PLUGIN_ID}/api/projects/${projectId}/namespaces/${namespaceId}/translations?page=${page}&showMissingOnly=${showMissingOnly}`
  ).then((res) => res.data);
};
...
const Translations = () => {
  ...
  const renderContent = () => {
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
      !!translations?.items?.length && /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, { marginBottom: "1rem", children: [
        /* @__PURE__ */ jsxRuntime.jsx(
          designSystem.Button,
          {
            marginRight: "1rem",
